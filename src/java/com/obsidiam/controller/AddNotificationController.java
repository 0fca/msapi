    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp){
        try {
            if(AuthHandler.getHandlerInstance().authenticate(req, resp, this)){
                ...
                OperationResultModel orm = DatabaseHelper.getInstance().addNotification((NotificationModel) JsonHelper.getInstance().deserialize(new String(buffer.array()), NotificationModel.class));
